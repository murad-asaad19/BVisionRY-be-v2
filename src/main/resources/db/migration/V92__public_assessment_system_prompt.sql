...
-- Allow the new prompt type alongside the existing ones.
...
ALTER TABLE prompt_templates ADD CONSTRAINT prompt_templates_prompt_type_check
    CHECK (prompt_type IN ('SYSTEM_PROMPT', 'TEAM_INSIGHT', 'PUBLIC_ASSESSMENT_SYSTEM_PROMPT'));
