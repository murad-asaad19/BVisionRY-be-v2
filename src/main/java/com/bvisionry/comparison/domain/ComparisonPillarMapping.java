...
/**
 * One pillar correspondence within a GLOBAL (baseline, distance) pipeline pair
 * (spec §5). Bare UUIDs only — no JPA relations across features. A row with a
 * null {@code distancePillarId} is "not re-measured"; a null
